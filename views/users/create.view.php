...
<main class="flex flex-col m-2 ">
    <form action="/register" method="POST" class="flex flex-col w-full rounded-md gap-2 p-4 md:w-1/2 md:border">
        <label for="name">Name</label>
        <input type="text" name="name" id="name" class="border rounded-md p-1" />
